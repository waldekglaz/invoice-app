        ...
        {!isNewInvoiceClicked && !isDetailOpen && (
          <div className="flex items-center justify-between py-9">
            ...
            <div>
              ...
              <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm pl-[6px] py-[6px] pr-[15px] text-center mb-2  flex items-center justify-between" onClick={addClickHandler}>
                <span className="bg-white block text-blue-700 text-4xl rounded-full w-8 h-8 mr-2">+</span>New
              </button>
            </div>
          </div>
        )}
