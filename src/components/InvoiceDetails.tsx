...
export default function InvoiceDetails({ onClick, status, id, description, senderAddress, createdAt, paymentDue, clientName, clientEmail, items, total, clientAddress }) {
  return (
